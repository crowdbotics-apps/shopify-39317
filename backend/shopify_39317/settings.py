"""
Django settings for shopify_39317 project.
...
ROOT_URLCONF = 'shopify_39317.urls'
...
WSGI_APPLICATION = 'shopify_39317.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "shopify_39317 API",
    "DESCRIPTION": "API documentation for shopify_39317 App",
    "VERSION": "v1",
}
